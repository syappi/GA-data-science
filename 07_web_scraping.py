...
p = b.find_all(name='li')
for tag in p:
    print tag.text

# print the text of only the API resources
q = b.find(name='ul', attrs={'id':'api'}).find_all(name='li')
for tag in q:
    print tag.text
...
# get the title
b.find(name='h1').find_all(name='span', attrs={'itemprop':'name', 'class':'itemprop'})[0].text
