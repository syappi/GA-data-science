...
import requests
r = requests.get('http://www.omdbapi.com/?t=the shawshank redemption&y=&plot=short&r=json&type=movie')
...
s = requests.get('http://www.omdbapi.com/?t=blablah&y=&plot=short&r=json&type=movie')
